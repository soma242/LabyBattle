...
[CreateAssetMenu(menuName = "dungeonScene/mapComponent/DownStairs")]
public class DownStairsSO : DungeonComponentSO
{
    ...
    public override void SetComponent(DisposableBagBuilder bag, DungeonPos pos)
    {
        ...
        var mapStairPub = GlobalMessagePipe.GetPublisher<DownStairsSetMessage>();
        mapStairPub.Publish(new DownStairsSetMessage(pos));

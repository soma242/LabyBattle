...
public static class FormationScope
{
    ...
    private static sbyte noneEnemy = -1;
    ...
    private static string allCharaString = "–¡•û‘S‘Ì";
    ...
    public static string AllCharaText()
    {
        return allCharaString;
    }

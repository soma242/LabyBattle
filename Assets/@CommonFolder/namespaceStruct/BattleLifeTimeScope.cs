...
namespace BattleSceneMessage
{
    ...
    public struct ActionSelectCancelPerfomeMessage { }
    ...
    */
    ...
    public struct BuffNoticeMessage 
    {
        public bool chara;
        public sbyte target;
        public BuffType type;
        public BuffNoticeMessage(bool chara, sbyte target, BuffType type)
        {
            this.chara= chara;
            this.target= target;
            this.type = type;
    ...
    //ResetSimulate
    public struct AllSimulateRestMessage { }

    public struct SimulateResetMessage
    {
        public sbyte pos;
        public SimulateResetMessage(sbyte pos)
        {
            this.pos = pos;
        }
    }
